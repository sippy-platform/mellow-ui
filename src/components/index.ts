...
export type { PivotProps } from './Pivot';

export { default as PivotItem } from './PivotItem';
export type { PivotItemProps } from './PivotItem';

export { default as PivotNav } from './PivotNav';
export type { PivotNavProps } from './PivotNav';

export { default as PivotPanel } from './PivotPanel';
export type { PivotPanelProps } from './PivotPanel';

export { default as PivotPanels } from './PivotPanels';
